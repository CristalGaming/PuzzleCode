...
public class EqualTextCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (!world.isClientSide()) {
			...
			if (_blockEntity != null)
				...
				}.getDirection(BlockPos.containing(x, y, z))).getClockWise(Direction.Axis.Y)).getStepZ()), "textCodeBlock")).equals(new Object() {
					public String getValue(LevelAccessor world, BlockPos pos, String tag) {
						BlockEntity blockEntity = world.getBlockEntity(pos);
						if (blockEntity != null)
							return blockEntity.getPersistentData().getString(tag);
				...
				}.getDirection(BlockPos.containing(x, y, z))).getCounterClockWise(Direction.Axis.Y)).getStepZ()), "textCodeBlock"))));
