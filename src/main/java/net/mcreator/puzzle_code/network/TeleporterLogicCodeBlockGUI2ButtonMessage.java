...
public class TeleporterLogicCodeBlockGUI2ButtonMessage {
	...
	public TeleporterLogicCodeBlockGUI2ButtonMessage(FriendlyByteBuf buffer) {
	...
	public TeleporterLogicCodeBlockGUI2ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(TeleporterLogicCodeBlockGUI2ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(TeleporterLogicCodeBlockGUI2ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = TeleporterLogicCodeBlockGUI2Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(TeleporterLogicCodeBlockGUI2ButtonMessage.class, TeleporterLogicCodeBlockGUI2ButtonMessage::buffer,
				TeleporterLogicCodeBlockGUI2ButtonMessage::new, TeleporterLogicCodeBlockGUI2ButtonMessage::handler);
	}
}
