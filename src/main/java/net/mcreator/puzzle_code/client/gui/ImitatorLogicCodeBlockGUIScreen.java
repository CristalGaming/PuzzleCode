...
public class ImitatorLogicCodeBlockGUIScreen extends AbstractContainerScreen<ImitatorLogicCodeBlockGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("puzzle_code:textures/screens/imitator_logic_code_block_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		if (LogicCodeBlockDisplayOnProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("puzzle_code:textures/screens/logic_true.png"), this.leftPos + 6, this.topPos + 54, 0, 0, 48, 20, 48, 20);
		}
		if (LogicCodeBlockDisplayOffProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("puzzle_code:textures/screens/logic_false.png"), this.leftPos + 6, this.topPos + 54, 0, 0, 48, 20, 48, 20);
		}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.puzzle_code.imitator_logic_code_block_gui.label_nbt_logiccodeblock"), 65, 59, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.puzzle_code.imitator_logic_code_block_gui.label_position"), 69, 14, -12829636, false);
