...
public class NearEntityYellowSwitchingBlockOffUpdateTickProcedure {
		...
		if (!hasPotion) {
			{
				...
				BlockState _bs = PuzzleCodeModBlocks.NEAR_ENTITY_YELLOW_SWITCHING_BLOCK.get().defaultBlockState();
