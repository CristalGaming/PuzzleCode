...
public class ReverseNearEntityYellowSwitchingBlockUpdateTickProcedure {
		...
		if (!hasPotion) {
			{
				...
				BlockState _bs = PuzzleCodeModBlocks.REVERSE_NEAR_ENTITY_YELLOW_SWITCHING_BLOCK_OFF.get().defaultBlockState();
