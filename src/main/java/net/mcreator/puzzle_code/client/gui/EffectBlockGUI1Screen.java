...
public class EffectBlockGUI1Screen extends AbstractContainerScreen<EffectBlockGUI1Menu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("puzzle_code:textures/screens/effect_block_gui_1.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "powerEffect")) + "", 5, 52, -12829636);
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "durationEffect")) + " ticks", 5, 115, -12829636);
		this.font.draw(poseStack, "[1]", 5, 133, -12829636);
	}
	...
	public void init() {
		...
		powerEffectField = new EditBox(this.font, this.leftPos + 5, this.topPos + 7, 162, 20, new TextComponent("Power")) {
			{
				setSuggestion("Power");
			}
		...
		durationEffectField = new EditBox(this.font, this.leftPos + 5, this.topPos + 65, 162, 20, new TextComponent("Duration")) {
			{
		...
		this.addRenderableWidget(new Button(this.leftPos + 5, this.topPos + 88, 77, 20, new TextComponent("Apply"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 23, this.topPos + 128, 14, 20, new TextComponent("2"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 91, this.topPos + 88, 77, 20, new TextComponent("Edit"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 41, this.topPos + 128, 14, 20, new TextComponent("3"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 59, this.topPos + 128, 14, 20, new TextComponent("4"), e -> {
			if (true) {
		...
		this.addRenderableWidget(new Button(this.leftPos + 77, this.topPos + 128, 14, 20, new TextComponent("5"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new EffectBlockGUI1ButtonMessage(7, x, y, z));
				EffectBlockGUI1ButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		}));
	}
}
