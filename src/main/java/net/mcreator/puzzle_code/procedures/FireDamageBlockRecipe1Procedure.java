...
public class FireDamageBlockRecipe1Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (new Object() {
		...
		}.getItemStack(world, new BlockPos(x, y, z), 1)).getItem() == Items.LAVA_BUCKET && (new Object() {
			public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				BlockEntity _ent = world.getBlockEntity(pos);
				if (_ent != null)
			...
			}
			{
				...
				if (_ent != null) {
					final int _slotid = 4;
					final ItemStack _setstack = new ItemStack(PuzzleCodeModBlocks.FIRE_DAMAGE_BLOCK.get());
