...
public class FillerCodeBlockGUI3ButtonMessage {
	private final int buttonID, x, y, z;

	public FillerCodeBlockGUI3ButtonMessage(FriendlyByteBuf buffer) {
	...
	public FillerCodeBlockGUI3ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(FillerCodeBlockGUI3ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(FillerCodeBlockGUI3ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = FillerCodeBlockGUI3Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(FillerCodeBlockGUI3ButtonMessage.class, FillerCodeBlockGUI3ButtonMessage::buffer, FillerCodeBlockGUI3ButtonMessage::new, FillerCodeBlockGUI3ButtonMessage::handler);
	}
}
