...
import net.mcreator.puzzle_code.procedures.EqualNumberCodeBlockUpdateTickProcedure;

import java.util.List;
import java.util.Collections;

public class EqualNumberCodeBlockBlock extends Block {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public EqualNumberCodeBlockBlock() {
