...
public class PropertyTransferTextCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		{
			String _value = ((world.getBlockState(new BlockPos(x + ((new Object() {
			...
			}.getValue(world, new BlockPos(x, y, z), "setProperty"))) instanceof EnumProperty _enumProp && _enumProp.getValue(_value).isPresent())
