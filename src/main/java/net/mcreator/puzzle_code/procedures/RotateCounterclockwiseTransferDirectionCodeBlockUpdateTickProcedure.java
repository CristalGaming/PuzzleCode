...
public class RotateCounterclockwiseTransferDirectionCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		if (!world.isClientSide()) {
			...
			if (_blockEntity != null)
				_blockEntity.getPersistentData().putDouble("directionCodeBlock", (Direction.from3DDataValue((int) (new Object() {
				...
				}.getDirection(blockstate)).getOpposite()).getStepZ()), "directionCodeBlock"))).getCounterClockWise(Direction.Axis.Y)).get3DDataValue());
