...
public class TextCodeBlockGuiButtonMessage {
	private final int buttonID, x, y, z;

	public TextCodeBlockGuiButtonMessage(FriendlyByteBuf buffer) {
	...
	public TextCodeBlockGuiButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(TextCodeBlockGuiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(TextCodeBlockGuiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
