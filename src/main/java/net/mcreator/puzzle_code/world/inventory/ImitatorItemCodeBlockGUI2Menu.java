...
public class ImitatorItemCodeBlockGUI2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ImitatorItemCodeBlockGUI2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PuzzleCodeModMenus.IMITATOR_ITEM_CODE_BLOCK_GUI_2.get(), id);
