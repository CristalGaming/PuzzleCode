...
public class AdvancedTeleporterLogicCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (!world.isClientSide()) {
			...
			if (_blockEntity != null)
				...
				}.getValue(world, new BlockPos(x, y, z), "textCodeBlock")), (new Object() {
				...
				}.getDirection(new BlockPos(x, y, z))).getOpposite()).getStepZ() + z), "logicCodeBlock")));
