...
public class ImitatorTextCodeBlockGUIScreen extends AbstractContainerScreen<ImitatorTextCodeBlockGUIMenu> {
	private final static HashMap<String, Object> guistate = ImitatorTextCodeBlockGUIMenu.guistate;
	...
	private static final ResourceLocation texture = new ResourceLocation("puzzle_code:textures/imitator_text_code_block_gui.png");
