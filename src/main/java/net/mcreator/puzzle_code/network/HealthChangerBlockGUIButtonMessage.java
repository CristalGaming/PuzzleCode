...
public class HealthChangerBlockGUIButtonMessage {
	private final int buttonID, x, y, z;

	public HealthChangerBlockGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public HealthChangerBlockGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(HealthChangerBlockGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(HealthChangerBlockGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
