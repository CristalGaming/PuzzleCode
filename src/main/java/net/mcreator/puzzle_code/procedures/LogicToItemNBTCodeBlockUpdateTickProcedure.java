...
public class LogicToItemNBTCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		...
		itemSlot.getOrCreateTag().putBoolean("logicCodeItem", (new Object() {
		...
		}.getDirection(blockstate)).getOpposite()).getStepZ()), "logicCodeBlock")));
		{
