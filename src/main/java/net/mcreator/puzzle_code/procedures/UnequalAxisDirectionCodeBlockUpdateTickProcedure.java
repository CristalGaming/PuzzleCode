...
public class UnequalAxisDirectionCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (!world.isClientSide()) {
			...
			if (_blockEntity != null)
				_blockEntity.getPersistentData().putBoolean("directionCodeBlock", (!(Direction.from3DDataValue((int) (new Object() {
				...
				}.getDirection(BlockPos.containing(x, y, z))).getClockWise(Direction.Axis.Y)).getStepZ()), "directionCodeBlock"))).getAxis() == Direction.from3DDataValue((int) (new Object() {
					public double getValue(LevelAccessor world, BlockPos pos, String tag) {
						BlockEntity blockEntity = world.getBlockEntity(pos);
						if (blockEntity != null)
							return blockEntity.getPersistentData().getDouble(tag);
				...
				}.getDirection(BlockPos.containing(x, y, z))).getCounterClockWise(Direction.Axis.Y)).getStepZ()), "directionCodeBlock"))).getAxis())));
