...
public class CatapulterBlockGUI2ButtonMessage {
	private final int buttonID, x, y, z;

	public CatapulterBlockGUI2ButtonMessage(FriendlyByteBuf buffer) {
	...
	public CatapulterBlockGUI2ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(CatapulterBlockGUI2ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(CatapulterBlockGUI2ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = CatapulterBlockGUI2Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(CatapulterBlockGUI2ButtonMessage.class, CatapulterBlockGUI2ButtonMessage::buffer, CatapulterBlockGUI2ButtonMessage::new, CatapulterBlockGUI2ButtonMessage::handler);
	}
}
