...
public class ReverseYellowKillSwitchingBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		for (Entity entityiterator : new ArrayList<>(world.players())) {
			if ((entityiterator.getCapability(PuzzleCodeModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new PuzzleCodeModVariables.PlayerVariables())).IsSwitchedYellow
					...
					}.getValue(world, BlockPos.containing(x, y, z), "minPower")) {
				{
					...
					BlockState _bs = PuzzleCodeModBlocks.REVERSE_YELLOW_KILL_SWITCHING_BLOCK_OFF.get().defaultBlockState();
