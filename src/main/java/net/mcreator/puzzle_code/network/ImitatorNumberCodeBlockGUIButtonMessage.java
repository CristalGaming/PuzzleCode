...
public class ImitatorNumberCodeBlockGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(ImitatorNumberCodeBlockGUIButtonMessage.class, ImitatorNumberCodeBlockGUIButtonMessage::buffer,
				ImitatorNumberCodeBlockGUIButtonMessage::new, ImitatorNumberCodeBlockGUIButtonMessage::handler);
	}
}
