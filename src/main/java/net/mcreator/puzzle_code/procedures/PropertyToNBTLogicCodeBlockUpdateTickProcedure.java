	...
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (!world.isClientSide()) {
			...
			if (_blockEntity != null)
				_blockEntity.getTileData().putBoolean((new Object() {
				...
				}.getValue(world, new BlockPos(x, y, z), "setNBT")), ((world.getBlockState(new BlockPos(x + ((new Object() {
					public Direction getDirection(BlockPos pos) {
						BlockState _bs = world.getBlockState(pos);
						Property<?> property = _bs.getBlock().getStateDefinition().getProperty("facing");
						if (property != null && _bs.getValue(property) instanceof Direction _dir)
				...
				}.getDirection(new BlockPos(x, y, z))).getOpposite()).getStepZ()))).getBlock().getStateDefinition().getProperty((new Object() {
					public String getValue(LevelAccessor world, BlockPos pos, String tag) {
						BlockEntity blockEntity = world.getBlockEntity(pos);
						if (blockEntity != null)
							return blockEntity.getTileData().getString(tag);
						...
						}.getDirection(new BlockPos(x, y, z))).getOpposite()).getStepZ()))).getValue(_getbp18)));
