...
public class ReplacerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ReplacerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PuzzleCodeModMenus.REPLACER_GUI.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 7, 62) {
