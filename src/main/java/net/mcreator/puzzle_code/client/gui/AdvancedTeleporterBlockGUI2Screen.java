...
public class AdvancedTeleporterBlockGUI2Screen extends AbstractContainerScreen<AdvancedTeleporterBlockGUI2Menu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		if (WalkingReactDisplayOnProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("puzzle_code:textures/screens/logic_true.png"), this.leftPos + 86, this.topPos + 19, 0, 0, 48, 20, 48, 20);
		}
		if (WalkingReactDisplayOffProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("puzzle_code:textures/screens/logic_false.png"), this.leftPos + 86, this.topPos + 19, 0, 0, 48, 20, 48, 20);
		}
		if (ClickingReactDisplayOnProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("puzzle_code:textures/screens/logic_true.png"), this.leftPos + 86, this.topPos + 55, 0, 0, 48, 20, 48, 20);
		}
		if (ClickingReactDisplayOffProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("puzzle_code:textures/screens/logic_false.png"), this.leftPos + 86, this.topPos + 55, 0, 0, 48, 20, 48, 20);
		}
		if (RedstoneReactDisplayOnProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("puzzle_code:textures/screens/logic_true.png"), this.leftPos + 82, this.topPos + 91, 0, 0, 48, 20, 48, 20);
		}
		if (RedstoneReactDisplayOffProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("puzzle_code:textures/screens/logic_false.png"), this.leftPos + 82, this.topPos + 91, 0, 0, 48, 20, 48, 20);
		}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.puzzle_code.advanced_teleporter_block_gui_2.label_react_when_is_walked"), 23, 5, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.puzzle_code.advanced_teleporter_block_gui_2.label_react_when_is_clicked"), 23, 41, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.puzzle_code.advanced_teleporter_block_gui_2.label_react_when_it_gets_redstone"), 5, 77, -12829636, false);
	}
	...
	public void init() {
		super.init();
		button_3 = Button.builder(Component.translatable("gui.puzzle_code.advanced_teleporter_block_gui_2.button_3"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 91, this.topPos + 118, 18, 20).build();
		guistate.put("button:button_3", button_3);
		this.addRenderableWidget(button_3);
		button_1 = Button.builder(Component.translatable("gui.puzzle_code.advanced_teleporter_block_gui_2.button_1"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 46, this.topPos + 118, 18, 20).build();
		guistate.put("button:button_1", button_1);
		this.addRenderableWidget(button_1);
		button_2 = Button.builder(Component.translatable("gui.puzzle_code.advanced_teleporter_block_gui_2.button_2"), e -> {
			if (true) {
		...
		}).bounds(this.leftPos + 68, this.topPos + 118, 18, 20).build();
		guistate.put("button:button_2", button_2);
		this.addRenderableWidget(button_2);
		imagebutton_change_button = new ImageButton(this.leftPos + 55, this.topPos + 91, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_change_button.png"), 20, 40, e -> {
			if (true) {
		...
		imagebutton_change_button1 = new ImageButton(this.leftPos + 55, this.topPos + 55, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_change_button1.png"), 20, 40, e -> {
			if (true) {
		...
		imagebutton_change_button2 = new ImageButton(this.leftPos + 55, this.topPos + 19, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_change_button2.png"), 20, 40, e -> {
			if (true) {
