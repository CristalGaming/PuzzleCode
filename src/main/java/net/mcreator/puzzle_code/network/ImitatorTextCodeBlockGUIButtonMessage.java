...
public class ImitatorTextCodeBlockGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(ImitatorTextCodeBlockGUIButtonMessage.class, ImitatorTextCodeBlockGUIButtonMessage::buffer, ImitatorTextCodeBlockGUIButtonMessage::new, ImitatorTextCodeBlockGUIButtonMessage::handler);
	}
}
