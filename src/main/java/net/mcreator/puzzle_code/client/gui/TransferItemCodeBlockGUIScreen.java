...
public class TransferItemCodeBlockGUIScreen extends AbstractContainerScreen<TransferItemCodeBlockGUIMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "setSlotNumber")) + "", 6, 110, -12829636);
	}
	...
	public void init() {
		...
		setSlotID = new EditBox(this.font, this.leftPos + 6, this.topPos + 65, 162, 20, new TextComponent("To Slot")) {
			{
