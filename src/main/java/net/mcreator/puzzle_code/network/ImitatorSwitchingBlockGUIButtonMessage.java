...
public class ImitatorSwitchingBlockGUIButtonMessage {
	private final int buttonID, x, y, z;

	public ImitatorSwitchingBlockGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public ImitatorSwitchingBlockGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(ImitatorSwitchingBlockGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(ImitatorSwitchingBlockGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = ImitatorSwitchingBlockGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(ImitatorSwitchingBlockGUIButtonMessage.class, ImitatorSwitchingBlockGUIButtonMessage::buffer, ImitatorSwitchingBlockGUIButtonMessage::new, ImitatorSwitchingBlockGUIButtonMessage::handler);
	}
}
