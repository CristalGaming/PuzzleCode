...
public class TeleporterLogicCodeBlockGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(TeleporterLogicCodeBlockGUIButtonMessage.class, TeleporterLogicCodeBlockGUIButtonMessage::buffer,
				TeleporterLogicCodeBlockGUIButtonMessage::new, TeleporterLogicCodeBlockGUIButtonMessage::handler);
	}
}
