...
public class TeleporterItemCodeBlockGUI1ButtonMessage {
	private final int buttonID, x, y, z;

	public TeleporterItemCodeBlockGUI1ButtonMessage(FriendlyByteBuf buffer) {
	...
	public TeleporterItemCodeBlockGUI1ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(TeleporterItemCodeBlockGUI1ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(TeleporterItemCodeBlockGUI1ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
