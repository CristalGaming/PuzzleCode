...
public class TextToItemNBTCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		...
		itemSlot.getOrCreateTag().putString("textCodeItem", (new Object() {
		...
		}.getDirection(blockstate)).getOpposite()).getStepZ()), "textCodeBlock")));
		{
