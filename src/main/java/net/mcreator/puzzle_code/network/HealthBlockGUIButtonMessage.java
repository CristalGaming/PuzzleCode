...
import net.mcreator.puzzle_code.procedures.HealthBlockGUIPageRedstoneReactProcedure;
import net.mcreator.puzzle_code.procedures.HealthBlockGUIPageClickingReactProcedure;
import net.mcreator.puzzle_code.procedures.HealthBlockGUIPAgeWalkingReactProcedure;
...
public class HealthBlockGUIButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 2) {
			...
			HealthBlockGUIPAgeWalkingReactProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 3) {

			HealthBlockGUIPageClickingReactProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 4) {

			HealthBlockGUIPageRedstoneReactProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(HealthBlockGUIButtonMessage.class, HealthBlockGUIButtonMessage::buffer, HealthBlockGUIButtonMessage::new, HealthBlockGUIButtonMessage::handler);
	}
}
