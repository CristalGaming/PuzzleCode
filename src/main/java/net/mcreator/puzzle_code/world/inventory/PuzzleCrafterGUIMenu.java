...
public class PuzzleCrafterGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PuzzleCrafterGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PuzzleCodeModMenus.PUZZLE_CRAFTER_GUI, id);
