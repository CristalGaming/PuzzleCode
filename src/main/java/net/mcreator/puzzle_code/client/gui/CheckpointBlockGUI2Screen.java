...
public class CheckpointBlockGUI2Screen extends AbstractContainerScreen<CheckpointBlockGUI2Menu> {
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 6, this.topPos + 81, 56, 20, new TextComponent("Switch"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new CheckpointBlockGUI2ButtonMessage(5, x, y, z));
				CheckpointBlockGUI2ButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		}));
	}
}
