...
public class BlockFromPositionCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		{
			...
			if (_ent != null) {
				final int _slotid = 0;
				final ItemStack _setstack = (new ItemStack((world.getBlockState(BlockPos.containing(new Object() {
				...
				}.getDirection(blockstate)).getOpposite()).getStepZ()), "xPos"), new Object() {
					public double getValue(LevelAccessor world, BlockPos pos, String tag) {
						BlockEntity blockEntity = world.getBlockEntity(pos);
						if (blockEntity != null)
							return blockEntity.getPersistentData().getDouble(tag);
				...
				}.getDirection(blockstate)).getOpposite()).getStepZ()), "yPos"), new Object() {
					public double getValue(LevelAccessor world, BlockPos pos, String tag) {
						BlockEntity blockEntity = world.getBlockEntity(pos);
						if (blockEntity != null)
							return blockEntity.getPersistentData().getDouble(tag);
				...
				}.getDirection(blockstate)).getOpposite()).getStepZ()), "zPos")))).getBlock()));
