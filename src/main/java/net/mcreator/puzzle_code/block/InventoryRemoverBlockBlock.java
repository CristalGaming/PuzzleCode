...
import net.mcreator.puzzle_code.procedures.ItemRemoverBlockRedstoneOnProcedure;
import net.mcreator.puzzle_code.procedures.ItemRemoverBlockEntityWalksOnTheBlockProcedure;

import java.util.List;
import java.util.Collections;

public class InventoryRemoverBlockBlock extends Block {
	public InventoryRemoverBlockBlock() {
	...
	public void neighborChanged(BlockState blockstate, Level world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
		...
		if (world.getBestNeighborSignal(pos) > 0) {
			ItemRemoverBlockRedstoneOnProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
		}
	}
