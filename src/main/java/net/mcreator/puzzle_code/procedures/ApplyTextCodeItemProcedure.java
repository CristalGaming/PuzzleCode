...
public class ApplyTextCodeItemProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, HashMap guistate) {
		...
		ItemSlot.getOrCreateTag().putString("textCodeItem", (guistate.containsKey("text:textCodeItemField") ? ((EditBox) guistate.get("text:textCodeItemField")).getValue() : ""));
		{
