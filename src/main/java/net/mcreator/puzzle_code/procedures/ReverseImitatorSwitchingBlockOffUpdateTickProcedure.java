...
public class ReverseImitatorSwitchingBlockOffUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (!(new Object() {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "getNBT"))))) {
			{
				...
				BlockState _bs = PuzzleCodeModBlocks.REVERSE_IMITATOR_SWITCHING_BLOCK.get().defaultBlockState();
