...
public class RightTransferItemCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		{
			BlockEntity _ent = world.getBlockEntity(new BlockPos(x + ((new Object() {
			...
			}.getDirection(new BlockPos(x, y, z))).getClockWise(Direction.Axis.Y)).getStepZ()));
			if (_ent != null) {
