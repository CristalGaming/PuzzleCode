...
public class FillerItemCodeBlockGUI2Screen extends AbstractContainerScreen<FillerItemCodeBlockGUI2Menu> {
	private final static HashMap<String, Object> guistate = FillerItemCodeBlockGUI2Menu.guistate;
	...
	private static final ResourceLocation texture = new ResourceLocation("puzzle_code:textures/filler_item_code_block_gui_2.png");
