...
import net.mcreator.puzzle_code.network.TeleporterNumberCodeBlockGUIButtonMessage;
...
public class TeleporterNumberCodeBlockGUIScreen extends AbstractContainerScreen<TeleporterNumberCodeBlockGUIMenu> {
	private final static HashMap<String, Object> guistate = TeleporterNumberCodeBlockGUIMenu.guistate;
	...
	public TeleporterNumberCodeBlockGUIScreen(TeleporterNumberCodeBlockGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("puzzle_code:textures/screens/teleporter_number_code_block_gui.png");
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 173, this.topPos + 6, 45, 20, new TextComponent("Apply"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterNumberCodeBlockGUIButtonMessage(0, x, y, z));
				TeleporterNumberCodeBlockGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		...
		this.addRenderableWidget(new Button(this.leftPos + 173, this.topPos + 42, 45, 20, new TextComponent("Apply"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterNumberCodeBlockGUIButtonMessage(1, x, y, z));
				TeleporterNumberCodeBlockGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + 173, this.topPos + 78, 45, 20, new TextComponent("Apply"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterNumberCodeBlockGUIButtonMessage(2, x, y, z));
				TeleporterNumberCodeBlockGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + 24, this.topPos + 119, 13, 20, new TextComponent("2"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterNumberCodeBlockGUIButtonMessage(3, x, y, z));
				TeleporterNumberCodeBlockGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + -42, this.topPos + 6, 45, 20, new TextComponent("Edit"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterNumberCodeBlockGUIButtonMessage(4, x, y, z));
				TeleporterNumberCodeBlockGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + -42, this.topPos + 42, 45, 20, new TextComponent("Edit"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterNumberCodeBlockGUIButtonMessage(5, x, y, z));
				TeleporterNumberCodeBlockGUIButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + -42, this.topPos + 78, 45, 20, new TextComponent("Edit"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterNumberCodeBlockGUIButtonMessage(6, x, y, z));
				TeleporterNumberCodeBlockGUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		}));
	}
}
