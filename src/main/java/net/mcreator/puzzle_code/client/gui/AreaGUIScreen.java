...
public class AreaGUIScreen extends AbstractContainerScreen<AreaGUIMenu> {
	private final static HashMap<String, Object> guistate = AreaGUIMenu.guistate;
	...
	public AreaGUIScreen(AreaGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("puzzle_code:textures/screens/area_gui.png");
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 146 && mouseX < leftPos + 166 && mouseY > topPos + 85 && mouseY < topPos + 105)
			guiGraphics.renderTooltip(font, Component.translatable("gui.puzzle_code.area_gui.tooltip_flips_the_current_selected_axis"), mouseX, mouseY);
	}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font,
				...
				ReturnCurrentSelectedAxisProcedure.execute(world, x, y, z), 146, 58, -12829636, false);
		...
		guiGraphics.drawString(this.font,
				...
				ReturnCurrentNBTAreaProcedure.execute(world, x, y, z), 33, 31, -12829636, false);
		guiGraphics.drawString(this.font,
	...
	public void init() {
		super.init();
		positionField = new EditBox(this.font, this.leftPos + 7, this.topPos + 9, 111, 18, Component.translatable("gui.puzzle_code.area_gui.positionField"));
		positionField.setMaxLength(32767);
		guistate.put("text:positionField", positionField);
		this.addWidget(this.positionField);
		button_x = Button.builder(Component.translatable("gui.puzzle_code.area_gui.button_x"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new AreaGUIButtonMessage(0, x, y, z));
				AreaGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}).bounds(this.leftPos + 6, this.topPos + 85, 18, 20).build();
		guistate.put("button:button_x", button_x);
		this.addRenderableWidget(button_x);
		button_y = Button.builder(Component.translatable("gui.puzzle_code.area_gui.button_y"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new AreaGUIButtonMessage(1, x, y, z));
				AreaGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}).bounds(this.leftPos + 29, this.topPos + 85, 18, 20).build();
		guistate.put("button:button_y", button_y);
		this.addRenderableWidget(button_y);
		button_z = Button.builder(Component.translatable("gui.puzzle_code.area_gui.button_z"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new AreaGUIButtonMessage(2, x, y, z));
				AreaGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}).bounds(this.leftPos + 51, this.topPos + 85, 18, 20).build();
		guistate.put("button:button_z", button_z);
		this.addRenderableWidget(button_z);
		button_back = Button.builder(Component.translatable("gui.puzzle_code.area_gui.button_back"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new AreaGUIButtonMessage(3, x, y, z));
				AreaGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		}).bounds(this.leftPos + 6, this.topPos + 107, 162, 20).build();
		guistate.put("button:button_back", button_back);
		this.addRenderableWidget(button_back);
		button_1 = Button.builder(Component.translatable("gui.puzzle_code.area_gui.button_1"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new AreaGUIButtonMessage(4, x, y, z));
				AreaGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}).bounds(this.leftPos + 74, this.topPos + 85, 31, 20).build();
		guistate.put("button:button_1", button_1);
		this.addRenderableWidget(button_1);
		button_2 = Button.builder(Component.translatable("gui.puzzle_code.area_gui.button_2"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new AreaGUIButtonMessage(5, x, y, z));
				AreaGUIButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		...
		imagebutton_enter_button = new ImageButton(this.leftPos + 146, this.topPos + 8, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_enter_button.png"), 20, 40, e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new AreaGUIButtonMessage(6, x, y, z));
				AreaGUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_edit_button = new ImageButton(this.leftPos + 123, this.topPos + 8, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_edit_button.png"), 20, 40, e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new AreaGUIButtonMessage(7, x, y, z));
				AreaGUIButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_swap_button = new ImageButton(this.leftPos + 146, this.topPos + 85, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_swap_button.png"), 20, 40, e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new AreaGUIButtonMessage(8, x, y, z));
				AreaGUIButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		});
