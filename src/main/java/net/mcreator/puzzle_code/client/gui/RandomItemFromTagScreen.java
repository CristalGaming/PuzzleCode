...
import net.mcreator.puzzle_code.network.RandomItemFromTagButtonMessage;
...
public class RandomItemFromTagScreen extends AbstractContainerScreen<RandomItemFromTagMenu> {
	private final static HashMap<String, Object> guistate = RandomItemFromTagMenu.guistate;
	...
	public RandomItemFromTagScreen(RandomItemFromTagMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("puzzle_code:textures/screens/random_item_from_tag.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.puzzle_code.random_item_from_tag.label_nbt"), 6, 43, -12829636, false);
	...
	public void init() {
		super.init();
		textCodeBlockField = new EditBox(this.font, this.leftPos + 7, this.topPos + 8, 118, 18, Component.translatable("gui.puzzle_code.random_item_from_tag.textCodeBlockField"));
		...
		imagebutton_edit_button = new ImageButton(this.leftPos + 128, this.topPos + 7, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_edit_button.png"), 20, 40, e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new RandomItemFromTagButtonMessage(0, x, y, z));
				RandomItemFromTagButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_enter_button = new ImageButton(this.leftPos + 150, this.topPos + 7, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_enter_button.png"), 20, 40, e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new RandomItemFromTagButtonMessage(1, x, y, z));
				RandomItemFromTagButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
