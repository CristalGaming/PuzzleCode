	...
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if ((((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 9, 9, 9), e -> true).stream().sorted(new Object() {
			Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
				...
				|| !(((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 9, 9, 9), e -> true).stream()
						.sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
							}
			...
			if (new Object() {
			...
			}.getValue(world, new BlockPos(x, y, z), "replaceInventory") || new Object() {
				public boolean getValue(LevelAccessor world, BlockPos pos, String tag) {
					BlockEntity blockEntity = world.getBlockEntity(pos);
					if (blockEntity != null)
						return blockEntity.getTileData().getBoolean(tag);
				...
				if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 9, 9, 9), e -> true).stream()
						.sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
							}
			...
			if (new Object() {
				...
				if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 9, 9, 9), e -> true).stream()
					...
					}.getItemStack(world, new BlockPos(x, y, z), 40));
					_setstack.setCount(new Object() {
						public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
							AtomicInteger _retval = new AtomicInteger(0);
							BlockEntity _ent = world.getBlockEntity(pos);
					...
					}.getAmount(world, new BlockPos(x, y, z), 40));
			...
			while (slot < 36) {
				...
				}.getValue(world, new BlockPos(x, y, z), "replaceInventory")) {
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 9, 9, 9), e -> true).stream()
							.sorted(new Object() {
								Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
									return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
			...
			if (new Object() {
			...
			}.getValue(world, new BlockPos(x, y, z), "replaceArmor")) {
				{
					Entity _entity = ((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 9, 9, 9), e -> true).stream()
							.sorted(new Object() {
								Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
									return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
								}
					...
					if (_entity instanceof Player _player) {
						...
						}.getItemStack(world, new BlockPos(x, y, z), 36)));
						_player.getInventory().setChanged();
				...
				}
				{
					...
					if (_entity instanceof Player _player) {
						...
						}.getItemStack(world, new BlockPos(x, y, z), 37)));
						_player.getInventory().setChanged();
					} else if (_entity instanceof LivingEntity _living) {
				...
				}
				{
					...
					if (_entity instanceof Player _player) {
						...
						}.getItemStack(world, new BlockPos(x, y, z), 38)));
						_player.getInventory().setChanged();
					} else if (_entity instanceof LivingEntity _living) {
				...
				}
				{
					...
					if (_entity instanceof Player _player) {
						...
						}.getItemStack(world, new BlockPos(x, y, z), 39)));
						_player.getInventory().setChanged();
					} else if (_entity instanceof LivingEntity _living) {
