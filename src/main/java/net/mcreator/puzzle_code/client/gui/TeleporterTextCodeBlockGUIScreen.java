...
import net.mcreator.puzzle_code.network.TeleporterTextCodeBlockGUIButtonMessage;
...
public class TeleporterTextCodeBlockGUIScreen extends AbstractContainerScreen<TeleporterTextCodeBlockGUIMenu> {
	private final static HashMap<String, Object> guistate = TeleporterTextCodeBlockGUIMenu.guistate;
	...
	public TeleporterTextCodeBlockGUIScreen(TeleporterTextCodeBlockGUIMenu container, Inventory inventory, Component text) {
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 173, this.topPos + 6, 45, 20, new TextComponent("Apply"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterTextCodeBlockGUIButtonMessage(0, x, y, z));
				TeleporterTextCodeBlockGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		...
		this.addRenderableWidget(new Button(this.leftPos + 173, this.topPos + 42, 45, 20, new TextComponent("Apply"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterTextCodeBlockGUIButtonMessage(1, x, y, z));
				TeleporterTextCodeBlockGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + 173, this.topPos + 78, 45, 20, new TextComponent("Apply"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterTextCodeBlockGUIButtonMessage(2, x, y, z));
				TeleporterTextCodeBlockGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + 24, this.topPos + 119, 14, 20, new TextComponent("2"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterTextCodeBlockGUIButtonMessage(3, x, y, z));
				TeleporterTextCodeBlockGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + -42, this.topPos + 6, 45, 20, new TextComponent("Edit"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterTextCodeBlockGUIButtonMessage(4, x, y, z));
				TeleporterTextCodeBlockGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + -42, this.topPos + 42, 45, 20, new TextComponent("Edit"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterTextCodeBlockGUIButtonMessage(5, x, y, z));
				TeleporterTextCodeBlockGUIButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + -42, this.topPos + 78, 45, 20, new TextComponent("Edit"), e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new TeleporterTextCodeBlockGUIButtonMessage(6, x, y, z));
				TeleporterTextCodeBlockGUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		}));
	}
}
