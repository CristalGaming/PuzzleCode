...
public class ApplyPositionValueAreaProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, HashMap guistate) {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "currentCoordinate") == 1) {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "currentCoordinate") == 2) {
			if (!world.isClientSide()) {
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockEntity _blockEntity = world.getBlockEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
				if (_blockEntity != null)
					...
					}.getValue(world, BlockPos.containing(x, y, z), "currentSelectedAxis")) + "Pos2"), new Object() {
						double convert(String s) {
							try {
								return Double.parseDouble(s.trim());
							} catch (Exception e) {
