...
public class CreativeSettingsGUIGamerulesButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(CreativeSettingsGUIGamerulesButtonMessage.class, CreativeSettingsGUIGamerulesButtonMessage::buffer, CreativeSettingsGUIGamerulesButtonMessage::new, CreativeSettingsGUIGamerulesButtonMessage::handler);
	}
}
