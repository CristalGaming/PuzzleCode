...
public class FillerCodeBlockGUI1ButtonMessage {
	private final int buttonID, x, y, z;

	public FillerCodeBlockGUI1ButtonMessage(FriendlyByteBuf buffer) {
	...
	public FillerCodeBlockGUI1ButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(FillerCodeBlockGUI1ButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(FillerCodeBlockGUI1ButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = FillerCodeBlockGUI1Menu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(FillerCodeBlockGUI1ButtonMessage.class, FillerCodeBlockGUI1ButtonMessage::buffer,
				FillerCodeBlockGUI1ButtonMessage::new, FillerCodeBlockGUI1ButtonMessage::handler);
	}
}
