...
public class YellowSwicherBlockGUIButtonMessage {
	private final int buttonID, x, y, z;

	public YellowSwicherBlockGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public YellowSwicherBlockGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(YellowSwicherBlockGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(YellowSwicherBlockGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
