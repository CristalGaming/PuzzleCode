...
public class AdvancedTeleporterBlockGuiButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(AdvancedTeleporterBlockGuiButtonMessage.class, AdvancedTeleporterBlockGuiButtonMessage::buffer, AdvancedTeleporterBlockGuiButtonMessage::new, AdvancedTeleporterBlockGuiButtonMessage::handler);
	}
}
