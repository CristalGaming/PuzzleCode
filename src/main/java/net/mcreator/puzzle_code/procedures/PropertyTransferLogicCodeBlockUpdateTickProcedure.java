...
public class PropertyTransferLogicCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		{
			...
			if (_bs.getBlock().getStateDefinition().getProperty((new Object() {
			...
			}.getValue(world, BlockPos.containing(x, y, z), "setProperty"))) instanceof BooleanProperty _booleanProp)
				world.setBlock(_pos, _bs.setValue(_booleanProp, ((world.getBlockState(BlockPos.containing(x + ((new Object() {
					public Direction getDirection(BlockPos pos) {
						BlockState _bs = world.getBlockState(pos);
						Property<?> property = _bs.getBlock().getStateDefinition().getProperty("facing");
						if (property != null && _bs.getValue(property) instanceof Direction _dir)
				...
				}.getValue(world, BlockPos.containing(x, y, z), "getProperty"))) instanceof BooleanProperty _getbp18 && (world.getBlockState(BlockPos.containing(x + ((new Object() {
					public Direction getDirection(BlockPos pos) {
						BlockState _bs = world.getBlockState(pos);
						Property<?> property = _bs.getBlock().getStateDefinition().getProperty("facing");
						if (property != null && _bs.getValue(property) instanceof Direction _dir)
				...
				}.getDirection(BlockPos.containing(x, y, z))).getOpposite()).getStepZ()))).getValue(_getbp18))), 3);
		}
	}
}
