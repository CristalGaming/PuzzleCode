...
public class AdvancedPlacerRedstoneOnProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (new Object() {
			...
			}.getValue(world, BlockPos.containing(x, y, z), "zPos")), (world.getBlockState(BlockPos.containing(z + ((new Object() {
			...
			}.getDirection(BlockPos.containing(x, y, z))).getOpposite()).getStepY(), x + ((new Object() {
				public Direction getDirection(BlockPos pos) {
					BlockState _bs = world.getBlockState(pos);
					Property<?> property = _bs.getBlock().getStateDefinition().getProperty("facing");
					if (property != null && _bs.getValue(property) instanceof Direction _dir)
