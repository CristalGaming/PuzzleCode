...
public class RotateClockwiseTransferDirectionCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		if (!world.isClientSide()) {
			...
			if (_blockEntity != null)
				...
				}.getDirection(blockstate)).getOpposite()).getStepZ()), "directionCodeBlock"))).getClockWise(Direction.Axis.Y)).get3DDataValue());
