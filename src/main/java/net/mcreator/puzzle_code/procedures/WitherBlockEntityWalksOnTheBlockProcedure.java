...
public class WitherBlockEntityWalksOnTheBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((!(entity instanceof Player _plr ? _plr.getAbilities().instabuild : false)
				|| (entity instanceof Player _plr ? _plr.getAbilities().instabuild : false) && world.getLevelData().getGameRules().getBoolean(PuzzleCodeModGameRules.BLOCKSAFFECTSYOU)) && new Object() {
			...
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				...
				}.getValue(world, BlockPos.containing(x, y, z), "potionEffect")), (new Object() {
					public boolean getValue(LevelAccessor world, BlockPos pos, String tag) {
						BlockEntity blockEntity = world.getBlockEntity(pos);
						if (blockEntity != null)
							return blockEntity.getPersistentData().getBoolean(tag);
