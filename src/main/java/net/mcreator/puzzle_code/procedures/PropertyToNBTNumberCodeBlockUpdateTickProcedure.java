...
public class PropertyToNBTNumberCodeBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (!world.isClientSide()) {
			...
			if (_blockEntity != null)
				...
				}.getValue(world, BlockPos.containing(x, y, z), "getProperty"))) instanceof IntegerProperty _getip18 ? (world.getBlockState(BlockPos.containing(x + ((new Object() {
					public Direction getDirection(BlockPos pos) {
						BlockState _bs = world.getBlockState(pos);
						Property<?> property = _bs.getBlock().getStateDefinition().getProperty("facing");
						if (property != null && _bs.getValue(property) instanceof Direction _dir)
				...
				}.getDirection(BlockPos.containing(x, y, z))).getOpposite()).getStepZ()))).getValue(_getip18) : -1));
