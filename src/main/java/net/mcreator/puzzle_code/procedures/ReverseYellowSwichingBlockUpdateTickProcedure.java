...
public class ReverseYellowSwichingBlockUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		{
			...
			for (Entity entityiterator : _players) {
				if ((entityiterator.getCapability(PuzzleCodeModVariables.PLAYER_VARIABLES_CAPABILITY, null)
						.orElse(new PuzzleCodeModVariables.PlayerVariables())).IsSwitchedYellow == true
								...
								}.getValue(world, new BlockPos(x, y, z), "minPower")) {
					{
						...
						BlockState _bs = PuzzleCodeModBlocks.REVERSE_YELLOW_SWITCHING_BLOCK_OFF.get().defaultBlockState();
