...
import net.mcreator.puzzle_code.procedures.ReturnDirectionCodeItemProcedure;
import net.mcreator.puzzle_code.network.DirectionCodeItemGUIButtonMessage;
...
public class DirectionCodeItemGUIScreen extends AbstractContainerScreen<DirectionCodeItemGUIMenu> {
	private final static HashMap<String, Object> guistate = DirectionCodeItemGUIMenu.guistate;
	...
	public DirectionCodeItemGUIScreen(DirectionCodeItemGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("puzzle_code:textures/screens/direction_code_item_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font,
				...
				ReturnDirectionCodeItemProcedure.execute(world, x, y, z), 7, 75, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.puzzle_code.direction_code_item_gui.label_nbt_directioncodeblock"), 7, 89, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_change_button = new ImageButton(this.leftPos + 57, this.topPos + 8, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_change_button.png"), 20, 40, e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new DirectionCodeItemGUIButtonMessage(0, x, y, z));
				DirectionCodeItemGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_change_button1 = new ImageButton(this.leftPos + 57, this.topPos + 30, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_change_button1.png"), 20, 40, e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new DirectionCodeItemGUIButtonMessage(1, x, y, z));
				DirectionCodeItemGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_change_button2 = new ImageButton(this.leftPos + 57, this.topPos + 53, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_change_button2.png"), 20, 40, e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new DirectionCodeItemGUIButtonMessage(2, x, y, z));
				DirectionCodeItemGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_change_button3 = new ImageButton(this.leftPos + 34, this.topPos + 30, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_change_button3.png"), 20, 40, e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new DirectionCodeItemGUIButtonMessage(3, x, y, z));
				DirectionCodeItemGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_change_button4 = new ImageButton(this.leftPos + 79, this.topPos + 30, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_change_button4.png"), 20, 40, e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new DirectionCodeItemGUIButtonMessage(4, x, y, z));
				DirectionCodeItemGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		...
		imagebutton_change_button5 = new ImageButton(this.leftPos + 79, this.topPos + 53, 20, 20, 0, 0, 20, new ResourceLocation("puzzle_code:textures/screens/atlas/imagebutton_change_button5.png"), 20, 40, e -> {
			if (true) {
				PuzzleCodeMod.PACKET_HANDLER.sendToServer(new DirectionCodeItemGUIButtonMessage(5, x, y, z));
				DirectionCodeItemGUIButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		});
