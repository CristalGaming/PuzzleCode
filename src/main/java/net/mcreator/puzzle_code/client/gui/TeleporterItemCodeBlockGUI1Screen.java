...
public class TeleporterItemCodeBlockGUI1Screen extends AbstractContainerScreen<TeleporterItemCodeBlockGUI1Menu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.puzzle_code.teleporter_item_code_block_gui_1.label_position"), 69, 9, -12829636, false);
	...
	public void init() {
		super.init();
		button_2 = Button.builder(Component.translatable("gui.puzzle_code.teleporter_item_code_block_gui_1.button_2"), e -> {
			if (true) {
		...
		button_1 = Button.builder(Component.translatable("gui.puzzle_code.teleporter_item_code_block_gui_1.button_1"), e -> {
			if (true) {
