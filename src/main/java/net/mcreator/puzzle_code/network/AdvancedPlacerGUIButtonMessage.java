...
public class AdvancedPlacerGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(AdvancedPlacerGUIButtonMessage.class, AdvancedPlacerGUIButtonMessage::buffer, AdvancedPlacerGUIButtonMessage::new, AdvancedPlacerGUIButtonMessage::handler);
	}
}
