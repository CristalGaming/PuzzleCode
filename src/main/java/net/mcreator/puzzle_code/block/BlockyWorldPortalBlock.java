...
import net.mcreator.puzzle_code.world.teleporter.BlockyWorldTeleporter;
import net.mcreator.puzzle_code.world.teleporter.BlockyWorldPortalShape;

import java.util.Random;
import java.util.Optional;

public class BlockyWorldPortalBlock extends NetherPortalBlock {
	public BlockyWorldPortalBlock() {
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<BlockyWorldPortalShape> optional = BlockyWorldPortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_,
		...
		return !flag && !p_54930_.is(this) && !(new BlockyWorldPortalShape(p_54931_, p_54932_, direction$axis1)).isComplete()
		...
		if (!entity.isPassenger() && !entity.isVehicle() && entity.canChangeDimensions() && !entity.level.isClientSide() && true) {
			if (entity.isOnPortalCooldown()) {
				entity.setPortalCooldown();
					...
					new ResourceLocation("puzzle_code:blocky_world"))) {
				entity.setPortalCooldown();
				teleportToDimension(entity, pos, ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("puzzle_code:blocky_world")));
			} else {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType),
				new BlockyWorldTeleporter(entity.getServer().getLevel(destinationType), pos));
	}
}
