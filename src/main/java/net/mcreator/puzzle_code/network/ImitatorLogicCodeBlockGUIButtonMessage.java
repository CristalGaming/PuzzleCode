...
public class ImitatorLogicCodeBlockGUIButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuzzleCodeMod.addNetworkMessage(ImitatorLogicCodeBlockGUIButtonMessage.class, ImitatorLogicCodeBlockGUIButtonMessage::buffer,
				ImitatorLogicCodeBlockGUIButtonMessage::new, ImitatorLogicCodeBlockGUIButtonMessage::handler);
	}
}
